...
var employeeId:number=91;
var employeeName:string='Suroj';
var employeeSalary:number=75000;
var employeeInfo:[number,string,number]=[employeeId,employeeName,employeeSalary];
